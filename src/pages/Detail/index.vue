            ...
            <div class="chooseArea">
              ...
              >
                ...
                <dd
                  ...
                  @click="changeColor(spuSaleAttrValue,spuSaleAttr.spuSaleAttrValueList)"
                >
...
import { mapGetters} from 'vuex';
  ...
  export default {
    ...
    // 页面一跳转也就是页面已挂载，就需要派发acation去发送请求
    mounted(){
      // 派发时应该传入商品id
    ...
    methods:{
      ...
      await this.$store.dispatch('getShopcartInfo',{
        ...
        // 进行路由的跳转,在进行路由跳转的时候还需要吧商品相关的信息给到下一级组件
        // 一些简单的数据可以通过query参数传递，比较复杂的参数可以通过会话存储（不持久化，刷新会消失）
        // 本地和会话存储：一般存储的都是字符串格式，所以需要转格式JSON.strinify
